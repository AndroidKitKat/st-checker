default:
	cd ~/Projects/st-checker && xsltproc -o rules/OsRules.xsl xsl/RuleGenerator.xsl ~/Documents/operatingsystem/input/operatingsystem.xml
...
#&& xsltproc OsRules.xsl examples/GoodExample.xml		